	...
	settings: {
		workflowFiles: {
			...
			allowedFrontmatterKeys: {
				name: "Дополнительные свойства метаданных",
				description: "Имена свойств метаданных (по одному в строке), которые проверка рабочих процессов молча допускает и которые сохраняются при записи. Используйте это, чтобы сохранять свойства соглашений хранилища, такие как uid или created, в заметках рабочих процессов.",
				reservedIgnored: "Зарезервированные свойства рабочего процесса проигнорированы: {keys}",
			},
		},
		triggers: {
			heading: "Триггеры",
